...
int main(void)
{
  ...
  osMessageQDef(Queue1, 4, uint32_t);
...
void StartSender2(void const * argument)
{
	...
	for(;;)
	{
		/* Put a different message into Queue with a 0 timeout */
